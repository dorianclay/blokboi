...
{
    PyObject *__pyx_r = 0;
    __Pyx_RefNannyDeclarations __Pyx_RefNannySetupContext("main (wrapper)", 0);
...
static CYTHON_SMALL_CODE int __Pyx_InitCachedConstants(void)
{
     ...
     *     test_game.newGame()
     */
    __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_test_game);
    if (unlikely(!__pyx_tuple_))
        __PYX_ERR(0, 6, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_tuple_);
    __Pyx_GIVEREF(__pyx_tuple_);
    __pyx_codeobj__2 = (PyObject *)__Pyx_PyCode_New(
        0, 0, 1, 0, CO_OPTIMIZED | CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_,
        __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_lib_cgame_pyx, __pyx_n_s_main_2, 6, __pyx_empty_bytes);
...
/*--- Execution code ---*/
     ...
     *     test_game.newGame()
     */
    __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3lib_5cgame_1main, NULL, __pyx_n_s_lib_cgame);
    if (unlikely(!__pyx_t_1))
        __PYX_ERR(0, 6, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    if (PyDict_SetItem(__pyx_d, __pyx_n_s_main_2, __pyx_t_1) < 0)
        __PYX_ERR(0, 6, __pyx_L1_error)
